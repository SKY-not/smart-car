...
const double x_rad = 2.2;
const double y_rad = -1;
const double x_rad2 = 1.5;
const double y_rad2 = -5.8;
const double k = 20;
const double k2 = 10;
...
void radiation_pub(const nav_msgs::Odometry msg_s){
    ...
    vec.push_back(k/dist_sqr(x,y,x_rad,y_rad)+k2/dist_sqr(x,y,x_rad2,y_rad2));
    vec.push_back(x);
    vec.push_back(y);
