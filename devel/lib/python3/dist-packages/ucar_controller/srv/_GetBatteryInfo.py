...
class GetBatteryInfoResponse(genpy.Message):
  _md5sum = "09500864f3616d2698455f9ade50f66b"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.battery_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.battery_state.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 32
      (_x.battery_state.voltage, _x.battery_state.temperature, _x.battery_state.current, _x.battery_state.charge, _x.battery_state.capacity, _x.battery_state.design_capacity, _x.battery_state.percentage, _x.battery_state.power_supply_status, _x.battery_state.power_supply_health, _x.battery_state.power_supply_technology, _x.battery_state.present,) = _get_struct_7f4B().unpack(str[start:end])
      ...
      self.battery_state.cell_voltage = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.battery_state.cell_temperature = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.battery_state.location = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.battery_state.serial_number = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.battery_state.cell_temperature.tostring())
      _x = self.battery_state.location
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.battery_state.cell_temperature = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
