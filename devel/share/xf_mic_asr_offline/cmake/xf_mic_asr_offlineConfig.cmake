...
if("TRUE" STREQUAL "TRUE")
  set(xf_mic_asr_offline_SOURCE_PREFIX /home/kiwi/SmartCar/smart-car/src/xf_mic_asr_offline)
  set(xf_mic_asr_offline_DEVEL_PREFIX /home/kiwi/SmartCar/smart-car/devel)
  ...
  set(xf_mic_asr_offline_INSTALL_PREFIX /home/kiwi/SmartCar/smart-car/install)
...
if(NOT "/home/kiwi/SmartCar/smart-car/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xf_mic_asr_offline' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kiwi/SmartCar/smart-car/src/xf_mic_asr_offline/${idir}'.  ${_report}")
    endif()
    _list_append_unique(xf_mic_asr_offline_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "libmsc.so")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(xf_mic_asr_offline_EXPORTED_TARGETS ${${xf_mic_asr_offline_dep}_EXPORTED_TARGETS})
endforeach()
