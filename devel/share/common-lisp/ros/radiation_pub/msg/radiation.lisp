...
(cl:in-package radiation_pub-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <radiation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'radiation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name radiation_pub-msg:<radiation> is deprecated: use radiation_pub-msg:radiation instead.")))

(cl:ensure-generic-function 'radiation-val :lambda-list '(m))
(cl:defmethod radiation-val ((m <radiation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader radiation_pub-msg:radiation-val is deprecated.  Use radiation_pub-msg:radiation instead.")
  (radiation m))
